...
public class LocationType implements BerType, Serializable {
	...
	private LocationEstimateType locationEstimateType = null;
	private DeferredLocationEventType deferredLocationEventType = null;
	
	public LocationType() {
	}

	public LocationType(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (deferredLocationEventType != null) {
			codeLength += deferredLocationEventType.encode(reverseOS, false);
		...
		if (locationEstimateType != null) {
			codeLength += locationEstimateType.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
				locationEstimateType = new LocationEstimateType();
				subCodeLength += locationEstimateType.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
				deferredLocationEventType = new DeferredLocationEventType();
				subCodeLength += deferredLocationEventType.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			int nextByte = is.read();
			if (berTag.tagNumber != 0 || berTag.tagClass != 0 || berTag.primitive != 0
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (locationEstimateType != null) {
			...
			sb.append("locationEstimateType: ").append(locationEstimateType);
		...
		if (deferredLocationEventType != null) {
			...
			sb.append("deferredLocationEventType: ").append(deferredLocationEventType);
			firstSelectedElement = false;
		}
