...
public class ContentExtensions implements BerType, Serializable {
	...
	public ContentExtensions(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (extensionInformation != null) {
			sublength = extensionInformation.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				int choiceDecodeLength = extensionInformation.decode(is, null);
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
			subCodeLength += length.decode(is);
			extensionInformation = new ExtensionInformation();
			subCodeLength += extensionInformation.decode(is, null);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (extensionInformation != null) {
			...
			sb.append("extensionInformation: ");
			extensionInformation.appendAsString(sb, indentLevel + 1);
			firstSelectedElement = false;
		}
