...
public class SGSNSMORecord implements BerType, Serializable {
	...
	private BCDDirectoryNumber destinationNumber = null;
	...
	public void setDestinationNumber(BCDDirectoryNumber destinationNumber) {
		this.destinationNumber = destinationNumber;
	}

	public BCDDirectoryNumber getDestinationNumber() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 18)) {
				destinationNumber = new BCDDirectoryNumber();
