...
public class SGSNMBMSRecord implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static class ListofRAs implements BerType, Serializable {

		private static final long serialVersionUID = 1L;

		public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
		public byte[] code = null;
		private List<RAIdentity> seqOf = null;

		public ListofRAs() {
			seqOf = new ArrayList<RAIdentity>();
		}

		public ListofRAs(byte[] code) {
			this.code = code;
		}

		public List<RAIdentity> getRAIdentity() {
			if (seqOf == null) {
				seqOf = new ArrayList<RAIdentity>();
			}
			return seqOf;
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (length.val == -1) {
				while (true) {
					...
					RAIdentity element = new RAIdentity();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<RAIdentity> it = seqOf.iterator();
				if (it.hasNext()) {
					sb.append(it.next());
					while (it.hasNext()) {
						sb.append(",\n");
	...
	private ListofRAs listofRAs = null;
	...
	private BerInteger numberofReceivingUE = null;
	private MBMSInformation mbmsInformation = null;
	
	public SGSNMBMSRecord() {
	}

	public SGSNMBMSRecord(byte[] code) {
		this.code = code;
	}
	...
	public void setListofRAs(ListofRAs listofRAs) {
		this.listofRAs = listofRAs;
	}

	public ListofRAs getListofRAs() {
		return listofRAs;
	}
	...
	public void setNumberofReceivingUE(BerInteger numberofReceivingUE) {
		this.numberofReceivingUE = numberofReceivingUE;
	}

	public BerInteger getNumberofReceivingUE() {
		return numberofReceivingUE;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (numberofReceivingUE != null) {
			codeLength += numberofReceivingUE.encode(reverseOS, false);
		...
		if (listofRAs != null) {
			codeLength += listofRAs.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 3)) {
				listofRAs = new ListofRAs();
				subCodeLength += listofRAs.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 16)) {
				numberofReceivingUE = new BerInteger();
				subCodeLength += numberofReceivingUE.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (listofRAs != null) {
			...
			sb.append("listofRAs: ");
			listofRAs.appendAsString(sb, indentLevel + 1);
		}
		...
		if (numberofReceivingUE != null) {
			...
			sb.append("numberofReceivingUE: ").append(numberofReceivingUE);
		}
